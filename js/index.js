...
var app = {
		client_id: "124025987309-0bgql780lnn3dsj4bu6hd7bn435inmn1.apps.googleusercontent.com",
		client_secret: "_hCo42sQMO5liHFpYBGEeYiM",
    ...
    showGreetView: function() {
        ...
        googleapi.getToken({
			...
			$('#email').html('<p class="text-left">'+" email :"+user.email+'</p>');
//			$('#name').html("Name :"+user.given_name);			
			$('#name').html('<p class="text-left">'+" Name :"+user.given_name+'</p>');
			$('#img').html('<img src="'+user.picture+'" alt=""  height="200" align="center" class="img-rounded img-responsive" >');	
			
			$('#takeaquiz').html('<a class="btn btn-google-plus-style btn-lg btn-block"><i class="fa fa-google-plus-square"></i>  <span>Launch Quiz</span></a>');
